...
One of the most significant findings from [DeepSeek-R1](https://arxiv.org/abs/2501.12948) is that reasoning capabilities can be distilled from large reasoning models into much smaller ones. DeepSeek released distilled variants ranging from 1.5B to 70B parameters that retained much of the reasoning quality of the full 671B-parameter model. This pattern — training a large reasoning model and distilling it into smaller deployment models — is likely to become a standard part of the model development pipeline.
